...
import { checkSession, getStoredPhone, generateNitaPayment, makePayment, sendWhatsAppMessage } from '@/app/actions/payments';
...
function NitaPaymentContent() {
  ...
  if (checkingSession) {
    return (
      <Layout title="NITA Payments" showHeader={false} showFooter={false}>
  ...
  return (
    <Layout title="NITA Payments" showMenu>
