...
import { generateOTP, verifyOTP } from '../../actions/tcc';
...
function OTPContent() {
  ...
  const redirectPath = searchParams.get('redirect') || '/tcc/validation';
  ...
  const handleVerifyOTP = async () => {
    ...
    try {
      ...
      try {
        const { saveKnownPhone, saveUserSession } = await import('../../_lib/session-store');
