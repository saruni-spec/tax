...
echo ""
echo "1. GUI Lookup:"
curl -s -X GET 'process.env.API_URL/itax/gui-lookup?gui=3490631&tax_payer_type=KE' -H 'x-source-for: whatsapp'
echo ""
echo ""
...
echo ""
echo "1. GUI Lookup:"
curl -s -X GET 'process.env.API_URL/itax/gui-lookup?gui=30848670&tax_payer_type=KE' -H 'x-source-for: whatsapp'
echo ""
echo ""
...
echo ""
echo "1. GUI Lookup:"
curl -s -X GET 'process.env.API_URL/itax/gui-lookup?gui=8841962&tax_payer_type=KE' -H 'x-source-for: whatsapp'
echo ""
echo ""
...
echo ""
echo "1. GUI Lookup:"
curl -s -X GET 'process.env.API_URL/itax/gui-lookup?gui=3746839&tax_payer_type=KE' -H 'x-source-for: whatsapp'
echo ""
echo ""
