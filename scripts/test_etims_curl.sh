...
echo "curl -X POST 'process.env.API_URL/ussd/buyer-initiated/lookup' \\"
echo "  -H 'Content-Type: application/json' \\"
echo "  -H 'x-forwarded-for: triple_2_ussd' \\"
echo "  -d '{\"pin_or_id\":\"A016678608H\"}'"
echo ""
echo "Response:"
curl -s -X POST 'process.env.API_URL/ussd/buyer-initiated/lookup' \
...
echo "curl -X POST 'process.env.API_URL/ussd/post-sale' \\"
echo "  -H 'Content-Type: application/json' \\"
echo "  -H 'x-forwarded-for: triple_2_ussd' \\"
echo "  -d '{\"msisdn\":\"254745050238\",\"total_amount\":100,\"items\":[{\"item_name\":\"Test Item\",\"taxable_amount\":100,\"quantity\":1}]}'"
echo ""
echo "Response:"
curl -s -X POST 'process.env.API_URL/ussd/post-sale' \
  -H 'Content-Type: application/json' \
  -H 'x-forwarded-for: triple_2_ussd' \
...
echo "curl -X POST 'process.env.API_URL/ussd/buyer-initiated/submit/invoice' \\"
echo "  -H 'Content-Type: application/json' \\"
echo "  -H 'x-forwarded-for: triple_2_ussd' \\"
...
echo ""
echo "Response:"
curl -s -X POST 'process.env.API_URL/ussd/buyer-initiated/submit/invoice' \
  -H 'Content-Type: application/json' \
  -H 'x-forwarded-for: triple_2_ussd' \
...
echo "curl -X GET 'process.env.API_URL/ussd/buyer-initiated/fetch/254745050238' \\"
echo "  -H 'x-forwarded-for: triple_2_ussd'"
echo ""
echo "Response:"
curl -s -X GET 'process.env.API_URL/ussd/buyer-initiated/fetch/254745050238' \
  -H 'x-forwarded-for: triple_2_ussd'
echo ""
echo ""
...
echo "curl -X POST 'process.env.API_URL/ussd/buyer-initiated/action/submit' \\"
echo "  -H 'Content-Type: application/json' \\"
echo "  -H 'x-forwarded-for: triple_2_ussd' \\"
echo "  -d '{\"action\":\"accept\",\"msisdn\":\"254745050238\",\"invoice\":\"BI-DUMMY-123\"}'"
echo ""
echo "Response:"
curl -s -X POST 'process.env.API_URL/ussd/buyer-initiated/action/submit' \
  -H 'Content-Type: application/json' \
  -H 'x-forwarded-for: triple_2_ussd' \
...
echo "curl -X POST 'process.env.API_URL/ussd/search/credit-note' \\"
echo "  -H 'Content-Type: application/json' \\"
echo "  -H 'x-forwarded-for: triple_2_ussd' \\"
echo "  -d '{\"msisdn\":\"254745050238\",\"invoice_no\":\"INV-TEST-001\"}'"
echo ""
echo "Response:"
curl -s -X POST 'process.env.API_URL/ussd/search/credit-note' \
  -H 'Content-Type: application/json' \
  -H 'x-forwarded-for: triple_2_ussd' \
...
echo "curl -X POST 'process.env.API_URL/ussd/submit/credit-note' \\"
echo "  -H 'Content-Type: application/json' \\"
echo "  -H 'x-forwarded-for: triple_2_ussd' \\"
...
echo ""
echo "Response:"
curl -s -X POST 'process.env.API_URL/ussd/submit/credit-note' \
  -H 'Content-Type: application/json' \
  -H 'x-forwarded-for: triple_2_ussd' \
